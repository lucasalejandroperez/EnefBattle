const styles = {
  ...
  btn: 'px-4 py-2 rounded-lg bg-siteCyan w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input: 'bg-siteDimBlack text-white outline-none focus:outline-siteCyan p-4 rounded-md sm:max-w-[50%] max-w-full',
  ...
  gameLoadVS: 'font-rajdhani font-extrabold text-siteCyan text-7xl mx-16',

  // gameInfo component
  gameInfoIconBox: 'absolute right-2 top-1/2',
  gameInfoIcon: 'bg-siteCyan w-10 h-10 rounded-md cursor-pointer',
  ...
  gameInfoSidebarClose: 'w-10 h-10 rounded-md bg-siteCyan text-white font-rajdhani font-extrabold text-xl cursor-pointer',
